...
TEST_F(BraveStaticRedirectNetworkDelegateHelperTest, ModifyCRLSet3) {
  net::TestDelegate test_delegate;
  GURL url(
      "https://www.google.com/dl/release2/chrome_component/LLjIBPPmveI_4988/4988"
      "_all_crl-set-6296993568184466307.data.crx3");
  std::unique_ptr<net::URLRequest> request = context()->CreateRequest(
      url, net::IDLE, &test_delegate, TRAFFIC_ANNOTATION_FOR_TESTS);
  std::shared_ptr<brave::BraveRequestInfo> before_url_context(
      new brave::BraveRequestInfo());
  ...
  brave::ResponseCallback callback;
  GURL expected_url(
      "https://crlsets.brave.com/release2/chrome_component/LLjIBPPmveI_4988/"
